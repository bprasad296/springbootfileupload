...
Click the Browse... button and choose a file to upload (of size less than 10MB)
Go in the directory you have set in the application.properties file: the uploaded file will be copied here.